...
pub const struct_wlr_drm_format = extern struct {
    format: u32 align(8),
    len: usize,
    capacity: usize,
    pub fn modifiers(self: anytype) @import("std").zig.c_translation.FlexibleArrayType(@TypeOf(self), u64) {
        const Intermediate = @import("std").zig.c_translation.FlexibleArrayType(@TypeOf(self), u8);
        const ReturnType = @import("std").zig.c_translation.FlexibleArrayType(@TypeOf(self), u64);
        return @ptrCast(ReturnType, @alignCast(@alignOf(u64), @ptrCast(Intermediate, self) + 24));
    }
};
...
pub extern fn wlr_drm_format_set_get(set: [*c]const struct_wlr_drm_format_set, format: u32) [*c]const struct_wlr_drm_format;
...
pub extern fn wlr_drm_format_set_intersect(dst: [*c]struct_wlr_drm_format_set, a: [*c]const struct_wlr_drm_format_set, b: [*c]const struct_wlr_drm_format_set) bool;
...
pub const offsetof = @compileError("unable to translate macro: undefined identifier `__builtin_offsetof`"); // /home/centra/test/zig-linux-x86_64-0.10.1/lib/include/stddef.h:104:9
...
pub const WLR_RENDER_DRM_FORMAT_SET_H = "";
...
pub const wlr_drm_format = struct_wlr_drm_format;
pub const wlr_drm_format_set = struct_wlr_drm_format_set;
